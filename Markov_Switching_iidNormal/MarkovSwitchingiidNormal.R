...
plot(dzeta1[5:724]~DatePlot, type="l", ylim=c(0.0,1.0), lwd=2, xlab="Date", ylab="Regime probabilities", xaxs="i", yaxs="i", xlim=c(jan08, dec10))
plot(data[6:725,5]~DatePlot, type="l", lwd=1.2, xaxs="i", yaxs="i", xlim=c(jan08, dec10), xlab="Date", ylab="Log returns", ylim=c(-0.11, 0.11))
...
testnlm <- nlm(condLogLik, p <- c(0.7, 0.8, mean(logRetFirstPeriod), mean(logRetFirstPeriod), sd(logRetFirstPeriod), sd(logRetFirstPeriod)), series=logRetFirstPeriod, iterlim=100)
testOptim <- optim(c(0.7, 0.8, mean(logRetFirstPeriod), mean(logRetFirstPeriod), sd(logRetFirstPeriod), sd(logRetFirstPeriod)), condLogLik, series=logRetFirstPeriod)
...
for (i in 0:10){
	for (j in 0:10){
		reestimate <-nlm(condLogLik, p <- c(0.7, 0.8, mean(logRetFirstPeriod), mean(logRetFirstPeriod), sd(logRetFirstPeriod), sd(logRetFirstPeriod)), data <-logRetFirstPeriod, iterlim=100)
